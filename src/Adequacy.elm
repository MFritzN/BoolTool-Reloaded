            ...
            :: (if showContent then
                    [ div [ class "card-content columns" ]
                        ...
                        , div [ class "column content" ]
                            ...
                            , p [] [ text "To add a function, enter it in the text field. Add it by clicking the button. You can add multiple functions by separating them with a comma." ]
                            , p [] [ text "The last row of the table will become green if the set of functions is adequate." ]
